  ...
  let(:event_trees) do
    {
      ...
      4 => Fixtures::EventFactory.request_response_tree,
      5 => Fixtures::EventFactory.request_response_tree,
      6 => Fixtures::EventFactory.request_response_tree,
      7 => Fixtures::EventFactory.request_response_tree,
      8 => Fixtures::EventFactory.request_response_tree,
      9 => Fixtures::EventFactory.request_response_tree,
      10 => Fixtures::EventFactory.request_response_tree,
      11 => Fixtures::EventFactory.request_response_tree,
    }
  end
